...
export default function Login() {
    return (
        <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
            <div className="w-80 p-6 m-auto bg-white rounded-md shadow-xl shadow-sky-600/40 ring ring-2 ring-sky-600 lg:max-w-xl">
                <h1 className="text-3xl font-semibold text-center text-sky-400  uppercase">
                    Sign in
                </h1>
                <form className="mt-6">
                    <div className="mb-2">
